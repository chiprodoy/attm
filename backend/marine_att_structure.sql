...
MySQL - 5.7.33 : Database - marine_att
*********************************************************************
*/
...
CREATE TABLE `template` (
  ...
  `TEMPLATE` mediumblob,
  `TEMPLATE2` mediumblob,
  `BITMAPPICTURE` mediumblob,
  `BITMAPPICTURE2` mediumblob,
  `BITMAPPICTURE3` mediumblob,
  `BITMAPPICTURE4` mediumblob,
  `USETYPE` smallint(6) DEFAULT NULL,
  `EMACHINENUM` varchar(3) DEFAULT NULL,
  `TEMPLATE1` mediumblob,
  `Flag` smallint(6) DEFAULT NULL,
  `DivisionFP` smallint(6) DEFAULT NULL,
  `TEMPLATE4` mediumblob,
  `TEMPLATE3` mediumblob
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
